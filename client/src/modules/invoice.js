  ...
  return (
    <>
      <div>
        ...
        <div className="flex h-[30rem] 2xl:h-full">
          {invoices && (
          ...
          {/* <InvoiceTemplate /> */}
          <div className="w-100 h-100 border-[#AEAEE3] border-[1px]  rounded-lg  flex flex-row gap-5 py-3 px-3 justify-center flex-wrap overflow-auto">
